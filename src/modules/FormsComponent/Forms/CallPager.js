...
class CallPager extends React.PureComponent {
  //MARK: - Constructor
    ...
    return (
      <View style={{flex: 1}}>
        <PagerForm
          ...
          applicationId={this.state.applicationId}></PagerForm>
      </View>
    );
  }
...
const CallPagerNew = withTheme(CallPager);

CallPagerNew.navigationOptions = ({navigation, screenProps, params}) => {
