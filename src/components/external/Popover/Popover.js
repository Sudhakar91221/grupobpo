  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    if (willBeVisible !== isVisible) {
      if (willBeVisible) {
        ...
        this.debug("UNSAFE_componentWillReceiveProps - Awaiting popover show");
      } else {
        if (this.state.visible) {
          ...
          this.debug("UNSAFE_componentWillReceiveProps - Hiding popover");
        }
        else {
          setTimeout(this.props.onCloseStart);
          setTimeout(this.props.onCloseComplete);
          this.debug("UNSAFE_componentWillReceiveProps - Popover never shown");
        }
      }
