...
export default class TextFieldCustom extends PureComponent {
  static defaultProps = {
  ...
  value() {
    let { text } = this.state;
    let { defaultValue,newValue } = this.props;

    let value = null

    if(newValue !== undefined) {
       value = this.newisDefaultVisible()?
      newValue:
      text;
    ...
    // if(this.props.newValue !== undefined) {
    //   return 'string' === typeof this.props.newValue?
    //   this.props.newValue:
    //   String(this.props.newValue);
    // }
  ...
  newisDefaultVisible() {
    ...
    let { newValue } = this.props;
    // this.props.changeDefaultValue

    return receivedFocus  && undefined !== newValue;
  }
