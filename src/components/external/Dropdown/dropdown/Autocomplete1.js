...
export default class Autocomplete extends PureComponent {
  ...
  constructor(props) {
    ...
    this.textfieldRef = this.updateRef.bind(this, 'textfield');
  ...
  onPressNew(event) {
    ...
    //   this.focused = true;
    // this.texfield.onFocus()
    this.textfieldRef.isFocused = true
      // onFocus();
  ...
  renderBase(props) {
    ...
    return (
      <TextField
        ...
        value={this.state.texfield}
        // isFocused={true}
        // autoFocus={true}
        editable={true}
        // onFocus={this.onPressNew}
        onChangeText={this.onPressNew}
        renderAccessory={renderAccessory}
        onChange={event =>
                        this.setState({ texfield: event.nativeEvent.text })}
        ref={this.textfieldRef}
        onStartShouldSetResponder={() => true}

        //               label='Category *'
        //               //value = {this.state.description}
        //               value = {this.state.productModel !== undefined ? this.state.productModel.category : this.state.category}
  ...
  onChangeText = (text) => {
    ...
    // const {props} = this
    // this.onPress
    //  this.setState({ [props.label]: text ,modal:true});
