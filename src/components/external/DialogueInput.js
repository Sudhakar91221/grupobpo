...
import { StyleSheet, Text, View, Modal, TextInput, TouchableOpacity,ActivityIndicator,
         Platform } from 'react-native';

class DialogInput extends React.PureComponent{
  constructor(props){
    super(props);
    this.state = { inputModal: '', openning: true,inputDescModal:'',openningDesc:true }
  }
  ...
  render(){
    ...
    if (!this.state.openningDesc) {
      ...
      description = this.props.initDescTextInput ? this.props.initDescTextInput : '';
    }
    ...
    let submitButton =  (
      <TouchableOpacity  style={styles.touch_modal}
                  onPress={() => {
                    ...
                    this.setState({ inputModal: '',openning: true,openningDesc:true,inputDescModal:'' })
                  }}>
    ...
    return(
      <Modal
        ...
        <View style={[styles.container, {...modalStyleProps}]}  >
          <TouchableOpacity style={styles.container} activeOpacity={1} onPress={() => { this.props.closeDialog(); this.setState({ inputModal: '',openning: true,openningDesc:true,inputDescModal:true })}} >
            <View style={[styles.modal_container, {...dialogStyleProps}]} >
              <View style={styles.modal_body} >
                ...
                <TextInput style={styles.input_container}
                 ...
                 <Text style={[styles.title_modal,{color:'red'}]}>{this.props.error}</Text>
                  }
