        ...
        return(
            <View style={{opacity: this.props.disabled?0.4:1}}>
                ...
                >
                        ...
                        {this.props.buttonOnRight ? (

                            <View style={[styles.leftRight, this.props.style, this.props.isSelected?{backgroundColor: this.context.highlightColor}:null]}>

                                <View style={styles.itemOnRight}>
                                    {children}
                                </View>
