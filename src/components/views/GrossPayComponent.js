...
class GrossPayComponent extends React.Component {
  constructor(props) {
    super(props);
      ...
      <View style={{flex: 1, flexDirection: 'row'}}>
        ...
        <View style={{flex: 0.9}}>
          <TextField
            ...
            onChange={event => this.setState({pay: event.nativeEvent.text})}
            onSubmitEditing={() => {
...
export default withTheme(GrossPayComponent);
